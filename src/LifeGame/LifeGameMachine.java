...
//		long startTime = System.currentTimeMillis();
		LifeGameMachine lGameMachine = new LifeGameMachine(30, 30);
		GameControl gameControl = new GameControl();
		Clock clock = new Clock(1000);
		gameControl.InitField(30, 30);
